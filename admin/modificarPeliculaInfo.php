...
if (!isset($_SESSION['usuario'])) {
    ...
    if ($tiempoTrancurrido > 300) {
        ...
        $queryPelicula = "SELECT * FROM pelicula WHERE id=$id";
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Sistema de Administracion - Modificar Pelicula - Informacions</title>
    ...
    <body class="insertarInformacion">
        ...
        <h1 class="tituloInsMod">Modificar Película</h1>
        ...
        <div class="container">
            <form class="form-horizontal" action="modificarInformacion.php" method="get">
                <input type="hidden" id="id" name="id" value="<?php echo $id ?>">
                <!--TITULO-->
                <div class="form-group">
                    <label class="control-label col-sm-2" for="titulo">Titulo:</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="titulo" placeholder="Ingrese el titulo en español de la película" name="titulo" required value="<?php echo $rowPelicula['titulo'] ?>">
                    </div>
                </div>
                <!--TITULO ORIGINAL-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="tituloOriginal" placeholder="Ingrese el titulo original de la película" name="tituloOriginal" required value="<?php echo $rowPelicula['tituloOriginal'] ?>">
                    </div>
                </div>
                <!--AÑO-->
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="number" min="0" max="9999" class="form-control" id="ano" placeholder="Ingrese el año" name="ano" required value="<?php echo $rowPelicula['ano'] ?>">
                    </div>
                </div>
                <!--CLASIFICACION-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control " id="clasificacion" name="clasificacion" required>
                            ...
                            while ($rowClasificacion = mysqli_fetch_array($resultClasificacion)) {
                                if ($rowPelicula['clasificacion'] == $rowClasificacion[categoria]) {
                                    echo "<option value='$rowClasificacion[categoria]' selected>$rowClasificacion[categoria] - $rowClasificacion[descripcion]</option>";
                                } else {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" min="0" max="10" step="0.1" class="form-control" id="puntuacion" placeholder="Ingrese la puntuación de Imdb" name="puntuacion" required value="<?php echo $rowPelicula['puntuacion'] ?>">
                    </div>
                </div>
                <!--IDIOMA-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="idioma" placeholder="Ingrese el idioma de la película. Separe con ; si son varios" name="idioma" required value="<?php echo $rowPelicula['idioma'] ?>">
                    </div>
                </div>
                <!--DURACIÓN-->
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="number" min="0" max="999" class="form-control" id="duracion" placeholder="Ingrese la duración" name="duracion" required value="<?php echo $rowPelicula['duracion'] ?>">
                    </div>
                </div>
                <!--PAIS-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="pais" placeholder="Ingrese el pais de la pelicula. Separe con ; si son varios" name="pais" required value="<?php echo $rowPelicula['pais'] ?>">
                    </div>
                </div>
                <!--SINOPSIS-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" rows="5" id="sinopsis" name="sinopsis" placeholder="Ingrese la sinopsis de la película" ><?php echo $rowPelicula['sinopsis'] ?></textarea>
                    </div>
                </div>
                <!--DIRECCIÓN-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="direccion" placeholder="Ingrese la dirección de la película. Separe con ; si son varios" name="direccion" required value="<?php echo $rowPelicula['direccion'] ?>">
                    </div>
                </div>
                <!--ELENCO-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="elenco" placeholder="Ingrese el elenco de la película. Separe con ; si son varios" name="elenco" required value="<?php echo $rowPelicula['elenco'] ?>">
                    </div>
                </div>
                <!--SITIO OFICIAL-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="sitioOficial" placeholder="Ingrese el link del sitio oficial de la película" name="sitioOficial" required value="<?php echo $rowPelicula['sitioOficial'] ?>">
                    </div>
                </div>
                <!--SITIO IMDB-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="sitioImdb" placeholder="Ingrese el link del sitio Imdb de la película" name="sitioImdb" required value="<?php echo $rowPelicula['sitioImdb'] ?>">
                    </div>
                </div>
                <!--TRÁILER-->
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="trailer" placeholder="Ingrese el link del tráiler de la película" name="trailer" required value="<?php echo $rowPelicula['trailer'] ?>">
                    </div>
                </div>
                <!--FECHA DE ESTRENO-->
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control" id="fechaEstreno" placeholder="Ingrese la fecha de estreno" name="fechaEstreno" required value="<?php echo $rowPelicula['fechaEstreno'] ?>">
                    </div>
                </div>
                <div class="form-group">        
