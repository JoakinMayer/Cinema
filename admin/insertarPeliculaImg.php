...
<html>
    ...
    <body class="insertarImagenes">
        ...
        <div class="container">
            <form class="row form-horizontal" action="insertarImagenes.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-5  poster">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="textoAltPoster" placeholder="Ingrese el texto alternativo de la imagen" name="textoAltPoster" required>
                        </div>
                    </div>
